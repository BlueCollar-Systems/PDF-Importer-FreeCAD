...
- The popup was a direct regression. A modal before every import is too much friction, and the LibreCAD sentence was a copy/paste leak into the SketchUp host. Resolution: remove the popup entirely and cover it with a source-level regression test.
